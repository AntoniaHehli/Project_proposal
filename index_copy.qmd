...
*ÄNDERUNG: BAR CHART NEU IN CHUNK "plot weekly emissions for simple approach"*
...
*ÄNDERUNG: CHUNK "plot overall emission of car for simple approach" ALLES VOM PLOT GELÖSCHT. DIE ERSTEN DREI ZEILEN BLEIBEN.

```{r get overall emission of car only for simple approach, output = TRUE}
...
*ÄNDERUNG: CHUNK "plot overall emission of car for speed approach" GELÖSCHT*

*ÄNDERUNG: CHUNK "plot average weekly emission" EINGEFÜGT*

*ÄNDERUNG: CHUNK "prepare data to enable comparison with Posmo emission data" EINGEFÜGT*
...
*ÄNDERUNG: CHUNK "PLOT OVERALL EMISSION OF CAR FOR COMPARISON OF BOTH APPROACHES" GELÖSCHT*

*ÄNDERUNG: CHUNK "plot average weekly emission" GELÖSCHT*

*ÄNDERUNG: CHUNKG "prepare data to enable comparison with Posmo emission data" NACH OBEN VERSCHOBEN VOR DIESEN UNTERTITEL*

**ÄNDERUNG ZU MACHEN: DIESER UNTERTITEL _LÖSCHEN_, HABE ICH ZUR BESSEREN ÜBERSICHT NOCHT NICHT GEMACHT, ABER WIR BRAUCHEN DEN NICHT MEHR.**


## Slope scenario
*ÄNDERUNG: CHUNK "add car emissions calculated using slope to emission data and create bar chart" EINGEFÜGT (VON WEITER UNTEN HOCHKOPIERT UND KLEINE ÄNDERUNGEN, Z.B. PLOTART ZU STACKED BAR CHART ETC)*
...
*ÄNDERUNG: TITLE ZU "COMPARISON OF ALL THREE SCENARIOS" GEÄNDERT*

*ÄNDERUNG: CHUNK "PLOT OVERALL EMISSION OF CAR FOR COMPARISON OF ALL THREE APPROACHES GELÖSCHT"*

*ÄNDERUNG: NEUER CHUNK EINGEFÜGT: "plot grouped bar chart for all car emission scenarios"*
...
*ÄNDERUNG: BAR CHART ZU STACKED BAR CHART UND TITELGRÖSSEN ANGEPASST UND UNTER "SLOPE SCENARIO VERSCHOBEN*

*ÄNDERUNG CHUNK "plot bar chart for emission of all transport modes using different approaches for car" GELÖSCHT*
