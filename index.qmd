...
```{r plot locations with emission increase due to slope}
...
```{r plot bar chart for emission of all transport modes using distance approach for car}
...
```{r plot bar chart for emission of all transport modes using speed approach for car}
...
```{r plot bar chart for emissions of all transport modes using slope approach for car}
