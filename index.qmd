...
ggplot() + 
  ...
  geom_sf(data = posmo_CH_traveldistance, aes(color = co2_emissions_g))+
  labs(title = "Total Emissions per Transport Mode and User",
     subtitle = "Movement trajectories in Switzerland",
     x = "E",
     y = "N")+
  scale_color_continuous(name = "CO2 emissions [g]")+
...
ggplot() + 
  ...
  geom_sf(data = posmo_ZH_traveldistance, aes(color = co2_emissions_g))+
  labs(title = "Total Emissions per Transport Mode and User",
