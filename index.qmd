...
plot(dhm25)
points(posmo_car_lv03$X, posmo_car_lv03$Y, col = factor(posmo_car_lv03$user_id))

```


*könnte man hier nur die Autotracks von 1, 2 und 3 filtern und über dem Plot vom DHM darstellen, also ganzes DHM plotten und dann die drei Tracks drüber. um diese These zu unterstützen?* *Das könnte ich (Antonia) am Abend anschauen*
